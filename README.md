...
![Test Panel](https://github.com/friendlyngeeks/pelican-installer/actions/workflows/panel.yml/badge.svg)
![Test Wings](https://github.com/friendlyngeeks/pelican-installer/actions/workflows/wings.yml/badge.svg)
![Shellcheck](https://github.com/friendlyngeeks/pelican-installer/actions/workflows/shellcheck.yml/badge.svg)
[![License: GPL v3](https://img.shields.io/github/license/friendlyngeeks/pelican-installer)](LICENSE)
...
For help and support regarding the script itself and **not the official Pelican project**, you can join the [Discord Chat](https://pterodactyl-installer.se/discord).
...
```bash
bash <(curl -Ss https://raw.githubusercontent.com/friendlyngeeks/pelican-installer/main/install.sh || wget -O - https://raw.githubusercontent.com/friendlyngeeks/pelican-installer/main/install.sh) auto
```
